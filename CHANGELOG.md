...
- **ReplayMod compatibility** — detects active ReplayMod replays and suppresses temporary local playback-position reports, preventing replay camera state from overwriting the live server display timeline.
