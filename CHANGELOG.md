...
- **ReplayMod compatibility** — local display video pauses/resumes with ReplayMod and is corrected to its millisecond replay playhead during rendering; temporary replay positions are never reported back to the live server display timeline.
