package com.dreamdisplayx.api.media.source.url
...
object BilibiliUrls {
    ...
    private val EP_RE = Regex("^[eE][pP](\\d+)$")

    /** A bangumi season id: `ss` followed by digits. */
    private val SS_RE = Regex("^[sS][sS](\\d+)$")
