...
/** Wire frame for the `dreamdisplayx:v2` channel: a type id plus the encoded packet bytes. */
@Serializable
data class Envelope(
...
object PacketRegistry {
    ...
    private val entries: List<Entry<out DreamPacket>> = listOf(
        ...
        Entry(PacketType.REMOTE_CONTROL_OPEN, RemoteControlOpen::class, RemoteControlOpen.serializer()),
    ...
    /** Encodes [packet] into envelope bytes ready for the `dreamdisplayx:v2` channel. */
