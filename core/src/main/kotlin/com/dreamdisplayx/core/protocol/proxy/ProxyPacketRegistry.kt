...
/** Wire frame for the `dreamdisplayx:proxy` channel: a type id plus the encoded packet bytes. */
@Serializable
...
/** Separate proxy packet registry (disjoint id-space from [com.dreamdisplayx.core.protocol.common.PacketRegistry]).
...
object ProxyPacketRegistry {
    ...
    /** Encodes [packet] into envelope bytes ready for the `dreamdisplayx:proxy` channel. */
