...
class DefaultRuntime(
...
) : DreamDisplaysXRuntime {
    /** Live module instances. */
    private val modules = LinkedHashMap<String, DreamDisplaysXModule>()
    ...
    @Synchronized
    override fun registerModule(module: DreamDisplaysXModule) {
    ...
    private fun install(module: DreamDisplaysXModule, chain: List<String> = emptyList()) {
