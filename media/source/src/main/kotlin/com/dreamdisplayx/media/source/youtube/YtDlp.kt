package com.dreamdisplayx.media.source.youtube
...
import com.dreamdisplayx.media.source.youtube.binary.YtDlpBinary
import com.dreamdisplayx.media.source.youtube.cache.YtFormatCache
import com.dreamdisplayx.media.source.youtube.cookie.YtCookieManager
import com.dreamdisplayx.media.source.youtube.model.YtStream
import com.dreamdisplayx.media.source.youtube.model.YtStreams
import com.dreamdisplayx.media.source.youtube.process.YtDlpClientRace
import com.dreamdisplayx.media.source.youtube.search.YtDlpSearchCache
...
object YtDlp {
    ...
    private val HEDGE_DELAY_MS: Long =
        System.getProperty("dreamdisplayx.ytdlpHedgeMs")?.toLongOrNull()?.coerceAtLeast(0L) ?: 0L
