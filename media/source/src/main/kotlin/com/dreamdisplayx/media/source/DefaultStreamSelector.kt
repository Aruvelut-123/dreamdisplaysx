...
class DefaultStreamSelector : StreamSelector {
    /** Logger. */
    private val logger = LoggerFactory.getLogger("DreamDisplaysX/DefaultStreamSelector")

    /** Whether to log debug messages. */
    private val debug: Boolean
        get() = System.getProperty("dreamdisplayx.debug")?.toBoolean() == true
    ...
    private val preferProgressiveAudio: Boolean =
        System.getProperty("dreamdisplayx.audio.preferProgressive", "true").toBoolean()
