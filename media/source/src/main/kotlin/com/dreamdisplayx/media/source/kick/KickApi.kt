package com.dreamdisplayx.media.source.kick
...
import com.dreamdisplayx.media.source.direct.DirectHlsPlaylist
...
object KickApi {
    /** Logger. */
    private val logger = LoggerFactory.getLogger("DreamDisplaysX/KickApi")
