...
- `system/` — `Processes`: subprocess plumbing shared by the external binaries the mod drives (`ffmpeg`).
...
- Do not put stream resolving, `FFmpeg` process management, or rendering here
