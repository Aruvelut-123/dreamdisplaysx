...
internal class FramePrebuffer(
    ...
    private val logger = LoggerFactory.getLogger("DreamDisplaysX/FramePrebuffer")
    ...
    companion object {
        ...
        val prebufferMs: Long =
            System.getProperty("dreamdisplayx.playback.prebufferMs")?.toLongOrNull()?.coerceIn(0, 5_000)
                ?: DEFAULT_PREBUFFER_MS

        /**
         * Longest the prefill may hold playout back, `-Ddreamdisplayx.playback.prebufferPrimeMs` to override. Only
        ...
        private val PRIME_DEADLINE_NANOS: Long =
            (System.getProperty("dreamdisplayx.playback.prebufferPrimeMs")?.toLongOrNull()?.coerceIn(0, 5_000)
