...
import com.dreamdisplayx.media.player.process.FFmpegCapabilities.PROBED_FILTERS
...
internal object FFmpegCapabilities {
    private val logger = LoggerFactory.getLogger("DreamDisplaysX/FFmpegCapabilities")
