...
import com.dreamdisplayx.media.player.pipeline.VideoFramePipe
...
object MediaProcess {
    ...
    /** Kill switch for GPU-side scaling (`-Ddreamdisplayx.hwscale=false` falls back to software scale). */
    private val HW_SCALE_ENABLED = System.getProperty("dreamdisplayx.hwscale", "true").toBoolean()
