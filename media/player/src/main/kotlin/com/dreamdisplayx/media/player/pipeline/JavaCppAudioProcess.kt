...
/**
 * A minimal [Process] wrapper that exposes a [JavaCppAudioDecoder]'s PCM output as an
 ...
 * [destroy] / [destroyForcibly] delegate to [JavaCppAudioDecoder.kill].
 */
internal class JavaCppAudioProcess(
    private val decoder: JavaCppAudioDecoder,
    ...
    override fun getOutputStream(): OutputStream =
        throw UnsupportedOperationException("JavaCppAudioProcess does not support stdin")
