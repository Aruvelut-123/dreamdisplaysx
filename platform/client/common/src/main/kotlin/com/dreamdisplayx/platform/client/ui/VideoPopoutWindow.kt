...
import com.dreamdisplayx.api.media.sink.service.VideoFrameSink
import com.dreamdisplayx.platform.client.Initializer
import com.dreamdisplayx.platform.client.popout.PopoutEvent
import com.dreamdisplayx.platform.client.popout.PopoutWindow
import com.dreamdisplayx.platform.client.popout.WindowBackend
import com.dreamdisplayx.platform.client.popout.WindowConfig
import com.dreamdisplayx.platform.client.render.AsyncTextureUploader
import com.dreamdisplayx.platform.client.render.UploadPixelFormat
...
class VideoPopoutWindow(
    ...
    private class GlfwBackend(private val onClose: () -> Unit) : PopoutBackend {
        ...
        private fun createWindow(videoW: Int, videoH: Int) {
            ...
            val handle = GLFW.glfwCreateWindow(w, h, "Dream DisplaysX", 0L, 0L)
            if (handle == 0L) {
        ...
        companion object {
            private val logger = LoggerFactory.getLogger("DreamDisplaysX/VideoPopout")
