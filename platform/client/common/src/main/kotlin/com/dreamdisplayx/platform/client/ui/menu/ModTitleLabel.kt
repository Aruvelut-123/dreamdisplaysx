...
import com.dreamdisplayx.util.UpdateCheck
...
/**
 * The "Dream DisplaysX x.y.z" label in the screen corner. Shows a bouncing update arrow when a newer
...
class ModTitleLabel {
    ...
    fun draw(g: GuiGraphicsCompat, x: Int, y: Int) {
        ...
        val name = Component.literal("Dream DisplaysX")
    ...
    companion object {
        private const val MODRINTH_URL = "https://github.com/Aruvelut-123/dreamdisplaysx/releases"
    }
}
