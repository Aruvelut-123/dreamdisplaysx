...
import com.dreamdisplayx.platform.client.ui.widgets.SuggestionsPanel
...
class MenuLayout private constructor(
    ...
    companion object {
        ...
        fun compute(screenW: Int, screenH: Int, lineHeight: Int): MenuLayout {
            ...
            val topRowFloor = 380 // enough for 5 existing rows (settings panel scrolls when rows overflow)
