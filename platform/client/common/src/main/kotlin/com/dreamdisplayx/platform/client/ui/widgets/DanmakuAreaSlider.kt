...
/**
 * Horizontal slider for the danmaku display area (fraction of the display height), with a visual
 * indicator that shades the used portion of the track.
 *
 * The label and the apply action are consumer-supplied.
 */
class DanmakuAreaSlider(
    initial: Double,
