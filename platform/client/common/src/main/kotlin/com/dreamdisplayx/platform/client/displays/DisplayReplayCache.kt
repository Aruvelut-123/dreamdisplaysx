...
internal object DisplayReplayCache {
    ...
    private val ttlMs: Long =
        System.getProperty("dreamdisplayx.cache.ttlMs")?.toLongOrNull()?.coerceAtLeast(0L) ?: DEFAULT_TTL_MS

    /** Total JVM-side memory cap for retained replay snapshots. */
    private val maxBytes: Long =
        System.getProperty("dreamdisplayx.cache.jvmMaxBytes")?.toLongOrNull()?.coerceAtLeast(0L)
