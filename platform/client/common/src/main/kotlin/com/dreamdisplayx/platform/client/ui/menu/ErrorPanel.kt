...
import com.dreamdisplayx.api.media.model.MediaFailureKind
...
import com.dreamdisplayx.platform.client.ui.menu.ErrorPanel.Companion.MAX_DETAIL_LINES
...
class ErrorPanel(
    ...
    fun render(g: GuiGraphicsCompat, screenW: Int, screenH: Int) {
        ...
        val hint = Component.translatable("dreamdisplayx.error.loadingerror.hint")
        ...
        g.drawPanel(font, panel, Component.translatable("dreamdisplayx.ui.error").string)
    ...
    companion object {
        ...
        private fun headlineKey(kind: MediaFailureKind?): String = when (kind) {
            MediaFailureKind.NETWORK -> "dreamdisplayx.error.kind.network"
            MediaFailureKind.DECODE -> "dreamdisplayx.error.kind.decode"
            MediaFailureKind.NOT_FOUND -> "dreamdisplayx.error.kind.notfound"
            MediaFailureKind.GEO_BLOCKED -> "dreamdisplayx.error.kind.geoblocked"
            MediaFailureKind.TIMEOUT -> "dreamdisplayx.error.kind.timeout"
            else -> "dreamdisplayx.error.kind.unknown"
        }
    }
}
