 ...
 * shared-context check in [VideoPopoutWindow]; hardware decode is handled by libvlc internally.
 */
object MinecraftClientCapabilityDetector : ClientCapabilityDetector {
    ...
    /** True when libvlc is available (hardware decode is auto-detected by libvlc). */
    override val supportsHardwareDecode: Boolean get() = true
    ...
    override fun detect(): ClientHello {
        ...
        return ClientHello(
            ...
            hwAccelBackend = "libvlc",
            // JavaCPP replaced by libvlc; all decode is handled by the bundled libvlc runtime
