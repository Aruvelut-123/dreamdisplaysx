...
import com.dreamdisplayx.core.protocol.common.hasFeature
...
import com.dreamdisplayx.platform.client.ui.PipCorner
import com.dreamdisplayx.platform.client.ui.widgets.SuggestionsController
...
class DisplayScreen(
    ...
    /** Wire ordinal of the scheduled [com.dreamdisplayx.api.playback.model.PlaybackAction] (`PLAY`/`PAUSE`), or `-1` when none is set. */
