...
/** Small popup listing [SortOption]s, opened from the suggestions panel's sort button. Same visual / interaction style as [com.dreamdisplayx.platform.client.ui.menu.PopoutDropdown]. */
class SortDropdown(
    ...
    /** Appear / disappear progress in 0..1, eased the same way as [com.dreamdisplayx.platform.client.ui.menu.PopoutDropdown]. */
