package com.dreamdisplayx.platform.proxy.bungeecord
...
/** `dreamdisplayx:proxy` channel tag, shared verbatim with the Velocity sibling (see that plugin's doc). */
 ...
 */
@BungeeCordOnly
class DreamDisplaysXBungeecord : Plugin(), Listener {
    override fun onEnable() {
        proxy.registerChannel(PROXY_CHANNEL)
        proxy.pluginManager.registerListener(this, this)
        refreshKnownServers()
        logger.info(
            "Dream DisplaysX proxy bridge ready on BungeeCord — " +
    ...
    fun onPluginMessage(event: PluginMessageEvent) {
        ...
        when (packet) {
            is BackendHello -> {
                ...
                logger.info(
                    "Backend '$serverName' announced itself (Dream DisplaysX ${packet.pluginVersion}, " +
