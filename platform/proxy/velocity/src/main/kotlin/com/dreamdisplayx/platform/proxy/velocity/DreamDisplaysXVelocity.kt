...
import com.dreamdisplayx.core.protocol.proxy.packets.ApplyNetworkWatchParty
import com.dreamdisplayx.core.protocol.proxy.packets.BackendDisplayIndex
import com.dreamdisplayx.core.protocol.proxy.packets.BackendHello
import com.dreamdisplayx.core.protocol.proxy.packets.ClockProbe
import com.dreamdisplayx.core.protocol.proxy.packets.ClockReply
import com.dreamdisplayx.core.protocol.proxy.packets.CloseNetworkWatchParty
import com.dreamdisplayx.core.protocol.proxy.packets.DisplayTokenResolved
import com.dreamdisplayx.core.protocol.proxy.packets.ListNetworkSessions
import com.dreamdisplayx.core.protocol.proxy.packets.NetworkFullscreenAck
import com.dreamdisplayx.core.protocol.proxy.packets.NetworkSessionList
import com.dreamdisplayx.core.protocol.proxy.packets.NetworkWatchPartyState
import com.dreamdisplayx.core.protocol.proxy.packets.PlayerFullscreenMinimized
import com.dreamdisplayx.core.protocol.proxy.packets.PlayerLeftNetwork
import com.dreamdisplayx.core.protocol.proxy.packets.PlayerReady
import com.dreamdisplayx.core.protocol.proxy.packets.PlayerTransferring
import com.dreamdisplayx.core.protocol.proxy.packets.ProxyPacket
import com.dreamdisplayx.core.protocol.proxy.ProxyPacketRegistry
import com.dreamdisplayx.core.protocol.proxy.packets.ProxyWelcome
import com.dreamdisplayx.core.protocol.proxy.packets.ReplayForPlayer
import com.dreamdisplayx.core.protocol.proxy.packets.ResolveDisplayToken
import com.dreamdisplayx.core.protocol.proxy.packets.StartNetworkFullscreen
import com.dreamdisplayx.core.protocol.proxy.packets.StartNetworkWatchParty
import com.dreamdisplayx.core.protocol.proxy.packets.StopNetworkFullscreen
import com.dreamdisplayx.platform.proxy.NetworkBackendRegistry
import com.dreamdisplayx.platform.proxy.NetworkDisplayIndex
import com.dreamdisplayx.platform.proxy.NetworkFullscreenManager
import com.dreamdisplayx.platform.proxy.NetworkTokenResolutions
import com.dreamdisplayx.platform.proxy.NetworkWatchPartyManager
...
/**
 * `dreamdisplayx:proxy` channel id, shared verbatim by the `BungeeCord` sibling
 * ([com.dreamdisplayx.platform.proxy.bungeecord.DreamDisplaysXBungeecord]) — both sides must agree on the
 * literal string, plugin-messaging channel ids are not otherwise unified across the two proxy APIs.
 */
private const val PROXY_CHANNEL = "dreamdisplayx:proxy"
...
@VelocityOnly
@Plugin(
    id = "dreamdisplayx-proxy",
    name = "Dream DisplaysX Proxy",
    version = PLUGIN_VERSION,
    authors = ["DreamDisplaysX"],
)
class DreamDisplaysXVelocity @Inject constructor(
    ...
    fun onProxyInitialize(event: ProxyInitializeEvent) {
        ...
        refreshKnownServers()
        logger.info(
            "Dream DisplaysX proxy bridge ready on Velocity — {} backend(s) configured: {}.",
    ...
    fun onPluginMessage(event: PluginMessageEvent) {
        ...
        when (packet) {
            is BackendHello -> {
                ...
                logger.info(
                    "Backend '{}' announced itself (Dream DisplaysX {}, MC {}, {}).",
