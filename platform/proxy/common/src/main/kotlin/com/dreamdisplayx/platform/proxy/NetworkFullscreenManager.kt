package com.dreamdisplayx.platform.proxy

import com.dreamdisplayx.core.protocol.proxy.packets.ApplyFullscreen
import com.dreamdisplayx.core.protocol.proxy.packets.NetworkSessionInfo
...
object NetworkFullscreenManager {
    ...
    /** Records a backend's [NetworkFullscreenAck][com.dreamdisplayx.core.protocol.proxy.packets.NetworkFullscreenAck]. */
    ...
    /** Live sessions still owed a retry on [serverName] — called on a [PlayerReady][com.dreamdisplayx.core.protocol.proxy.packets.PlayerReady]. */
