...
object DisplayActions {
    /** Logger. */
    private val logger = LoggerFactory.getLogger("DreamDisplaysX/DisplayActions")
    ...
    fun recordVersionAndCheckUpdates(player: Player, versionString: String) {
        logger.info("${player.name} joined with Dream DisplaysX ${versionString.sanitizedForLog()}.")
