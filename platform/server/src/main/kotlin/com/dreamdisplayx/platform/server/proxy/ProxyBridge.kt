package com.dreamdisplayx.platform.server.proxy
...
import com.dreamdisplayx.core.protocol.proxy.packets.ApplyFullscreen
...
import com.dreamdisplayx.core.protocol.proxy.packets.DisplayIndexEntry
...
import com.dreamdisplayx.core.protocol.proxy.packets.JoinNetworkWatchParty
...
import com.dreamdisplayx.core.protocol.proxy.ProxyPacketDirection
...
/** The single `dreamdisplayx:proxy` plugin-message channel, backend<->proxy only. */
const val PROXY_CHANNEL: String = "dreamdisplayx:proxy"
...
object ProxyBridge : PluginMessageListener {
    private val logger = LoggerFactory.getLogger("DreamDisplaysX/ProxyBridge")
    ...
    /** Called from [com.dreamdisplayx.platform.server.PaperServer.doEnable]. Resets per-session state. */
     ...
     * Called from [com.dreamdisplayx.platform.server.commands.subcommands.FullscreenCommand] instead
