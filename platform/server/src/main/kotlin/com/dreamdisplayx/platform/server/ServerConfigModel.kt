...
import com.dreamdisplayx.util.toPlainJsonValue
...
data class SettingsSection(
    ...
    val fullscreenDefaultMode: com.dreamdisplayx.api.playback.model.FullscreenMode
        get() = runCatching { com.dreamdisplayx.api.playback.model.FullscreenMode.valueOf(fullscreen.default_mode.uppercase()) }
            .getOrDefault(com.dreamdisplayx.api.playback.model.FullscreenMode.STANDARD)
    ...
    data class UpdatesConfig(
        ...
        val repo_name: String = "dreamdisplayx",
...
data class PermissionsSection(
    ...
    data class PermissionsConfig(
        ...
        val video: String = "dreamdisplayx.video",
        val info: String = "dreamdisplayx.info",
        val premium: String = "group.premium",
        val delete: String = "dreamdisplayx.delete",
        val list: String = "dreamdisplayx.list",
        val reload: String = "dreamdisplayx.reload",
        val updates: String = "dreamdisplayx.updates",
        val help: String = "dreamdisplayx.help",
        val stats: String = "dreamdisplayx.stats",
        val toggle_others: String = "dreamdisplayx.toggle.others",
        val local: String = "dreamdisplayx.local",
        val synced: String = "dreamdisplayx.synced",
        val broadcast: String = "dreamdisplayx.broadcast",
        val watchparty: String = "dreamdisplayx.watchparty",
        val lock: String = "dreamdisplayx.lock",
        val delete_others: String = "dreamdisplayx.delete.others",
        val create_bypass: String = "dreamdisplayx.create.bypass",
        val fullscreen_start: String = "dreamdisplayx.fullscreen.start",
        val fullscreen_stop: String = "dreamdisplayx.fullscreen.stop",
        val fullscreen_list: String = "dreamdisplayx.fullscreen.list",
        val fullscreen_network: String = "dreamdisplayx.fullscreen.network",
        val remote: String = "dreamdisplayx.remote",
        val custom: String = "dreamdisplayx.custom",
        val name: String = "dreamdisplayx.name",
...
fun parseServerConfig(t: TomlTable?): ParsedServerConfig = ParsedServerConfig(
    ...
    settings = SettingsSection(
        ...
        updates = SettingsSection.UpdatesConfig(
            ...
            repo_name = t?.getString("updates.repo_name") ?: "dreamdisplayx",
    ...
    permissions = PermissionsSection(
        permissions = PermissionsSection.PermissionsConfig(
            create = t?.getString("permissions.create") ?: "dreamdisplayx.create",
            video = t?.getString("permissions.video") ?: "dreamdisplayx.video",
            info = t?.getString("permissions.info") ?: "dreamdisplayx.info",
            premium = t?.getString("permissions.premium") ?: "group.premium",
            delete = t?.getString("permissions.delete") ?: "dreamdisplayx.delete",
            list = t?.getString("permissions.list") ?: "dreamdisplayx.list",
            reload = t?.getString("permissions.reload") ?: "dreamdisplayx.reload",
            updates = t?.getString("permissions.updates") ?: "dreamdisplayx.updates",
            help = t?.getString("permissions.help") ?: "dreamdisplayx.help",
            stats = t?.getString("permissions.stats") ?: "dreamdisplayx.stats",
            toggle_others = t?.getString("permissions.toggle_others") ?: "dreamdisplayx.toggle.others",
            local = t?.getString("permissions.local") ?: "dreamdisplayx.local",
            synced = t?.getString("permissions.synced") ?: "dreamdisplayx.synced",
            broadcast = t?.getString("permissions.broadcast") ?: "dreamdisplayx.broadcast",
            watchparty = t?.getString("permissions.watchparty") ?: "dreamdisplayx.watchparty",
            lock = t?.getString("permissions.lock") ?: "dreamdisplayx.lock",
            delete_others = t?.getString("permissions.delete_others") ?: "dreamdisplayx.delete.others",
            create_bypass = t?.getString("permissions.create_bypass") ?: "dreamdisplayx.create.bypass",
            fullscreen_start = t?.getString("permissions.fullscreen_start") ?: "dreamdisplayx.fullscreen.start",
            fullscreen_stop = t?.getString("permissions.fullscreen_stop") ?: "dreamdisplayx.fullscreen.stop",
            fullscreen_list = t?.getString("permissions.fullscreen_list") ?: "dreamdisplayx.fullscreen.list",
            fullscreen_network = t?.getString("permissions.fullscreen_network") ?: "dreamdisplayx.fullscreen.network",
            remote = t?.getString("permissions.remote") ?: "dreamdisplayx.remote",
            custom = t?.getString("permissions.custom") ?: "dreamdisplayx.custom",
            name = t?.getString("permissions.name") ?: "dreamdisplayx.name",
    ...
    fun extractLangFiles() {
        ...
        LANGUAGE_FILES.forEach { fileName ->
            runCatching {
                ...
                val resource = resourceLookup("assets/dreamdisplayx/lang/server/$fileName")
                    ?: resourceLookup("assets/dreamdisplayx/lang/$fileName")
                resource?.use { input ->
                    if (target.exists()) {
