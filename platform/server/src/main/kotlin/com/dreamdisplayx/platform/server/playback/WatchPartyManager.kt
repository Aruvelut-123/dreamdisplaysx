...
import com.dreamdisplayx.platform.server.proxy.TransferTracker
import java.util.*
...
object WatchPartyManager {
    ...
    /** Fired when a `virtual` session is closed, with its `sessionId` (the network party id) - the seam that lets [com.dreamdisplayx.platform.server.proxy.ProxyBridge] fan a `CloseNetworkWatchParty` out. */
    ...
    fun sendToMember(playerId: UUID, packet: com.dreamdisplayx.core.protocol.common.packets.DreamPacket) {
