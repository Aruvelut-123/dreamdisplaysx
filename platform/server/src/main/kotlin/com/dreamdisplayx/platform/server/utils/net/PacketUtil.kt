...
import com.dreamdisplayx.platform.server.utils.net.PacketUtil.writeUUID
...
@NullMarked
object PacketUtil {
    private val logger = LoggerFactory.getLogger("DreamDisplaysX/PacketUtil")
    private const val CHANNEL_DISPLAY_INFO = "dreamdisplayx:display_info"
    private const val CHANNEL_SYNC = "dreamdisplayx:sync"
    private const val CHANNEL_DELETE = "dreamdisplayx:delete"
    private const val CHANNEL_PREMIUM = "dreamdisplayx:premium"
    private const val CHANNEL_IS_ADMIN = "dreamdisplayx:is_admin"
    private const val CHANNEL_DISPLAY_ENABLED = "dreamdisplayx:display_enabled"
    private const val CHANNEL_REPORT_ENABLED = "dreamdisplayx:report_enabled"
    private const val CHANNEL_CLEAR_CACHE = "dreamdisplayx:clear_cache"
