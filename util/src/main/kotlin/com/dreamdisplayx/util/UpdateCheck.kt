...
object UpdateCheck {
    /** Logger. */
    private val logger = LoggerFactory.getLogger("DreamDisplaysX/UpdateCheck")

    /** GitHub releases API. */
    private const val API = "https://api.github.com/repos/Aruvelut-123/dreamdisplaysx/releases/latest"
            ...
            val body = DreamHttpClient.readText(
                ...
                DreamHttpClient.RequestOptions(
                    headers = DreamHttpClient.headersOf(
                        "User-Agent" to
                                "DreamDisplaysX/${GeneralUtil.getModVersion()} (+github.com/Aruvelut-123/dreamdisplaysx)",
